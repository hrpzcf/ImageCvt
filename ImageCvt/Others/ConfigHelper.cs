...
namespace ImageCvt
{
    ...
    {
        public const string libImgCvt = "libimgcvt.dll";

        private static readonly string localAppData = Environment.GetFolderPath(
            Environment.SpecialFolder.LocalApplicationData);
        private static readonly string configDir = Path.Combine(localAppData, "ImageCvt");
        ...
        private static readonly string dwebpBinaryFullPath = Path.Combine(executableDir, libImgCvt);
        private const string binariesResourcePrefix = "ImageCvt.Library";

        public static string DwebpFullPath => dwebpBinaryFullPath;

        public static string LibImgCvt => libImgCvt;
        ...
        public static string CheckExtractLibImageCvt()
        {
            string message = ExtractFile(binariesResourcePrefix, libImgCvt, executableDir,
